...
class CalendarComponent {
    ...
    getLessonByOrder(day, index, timeShift) {
        var _a;
        const found = (_a = this.timeTableData[day]) === null || _a === void 0 ? void 0 : _a.items.find((item) => item.order === index && item.timeShift == timeShift);
        return found;
    }
}
