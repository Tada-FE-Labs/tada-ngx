...
class TadaNgxCalendarCellComponent {
    ...
    onClickToJoinClassOnline() {
        ...
        if (!!((_b = (_a = this.schedule) === null || _a === void 0 ? void 0 : _a.details) === null || _b === void 0 ? void 0 : _b.online) && !!((_d = (_c = this.schedule) === null || _c === void 0 ? void 0 : _c.details) === null || _d === void 0 ? void 0 : _d.joinUrl)) {
            window.open((_f = (_e = this.schedule) === null || _e === void 0 ? void 0 : _e.details) === null || _f === void 0 ? void 0 : _f.joinUrl, '_blank');
        }
    }
...
class CalendarComponent {
    ...
    ngOnChanges(changes) {
        var _a, _b, _c, _d, _e, _f;
        if (((_a = changes['data']) === null || _a === void 0 ? void 0 : _a.currentValue) && ((_b = changes['data']) === null || _b === void 0 ? void 0 : _b.currentValue.length)) {
            this.onChangeSchedules();
        }
        if (((_c = changes['month']) === null || _c === void 0 ? void 0 : _c.firstChange) &&
            changes['month'].currentValue &&
            ((_d = changes['year']) === null || _d === void 0 ? void 0 : _d.firstChange) &&
        ...
        else if (((_e = changes['month']) === null || _e === void 0 ? void 0 : _e.currentValue) || ((_f = changes['year']) === null || _f === void 0 ? void 0 : _f.currentValue)) {
    ...
    renderDayOfWeek() {
        this.schedules = this.weekdays.reduce((prev, current) => (Object.assign(Object.assign({}, prev), { [current]: current })), {});
    }
    onChangeSchedules() {
    ...
    getLessonByOrder(day, index) {
        var _a;
        return (_a = this.timeTableData[day]) === null || _a === void 0 ? void 0 : _a.items.filter((item) => item.order === index && item.classShift == this.timeShift);
    }
}
