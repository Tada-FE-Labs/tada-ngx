...
class CalendarComponent {
    ...
    getLessonByOrder(day, index) {
        var _a;
        const found = (_a = this.timeTableData[day]) === null || _a === void 0 ? void 0 : _a.items.filter((item) => item.order === index && item.timeShift == this.timeShift);
        return found;
    }
}
